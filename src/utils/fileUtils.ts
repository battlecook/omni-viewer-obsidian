...
export class FileUtils {
     ...
     *  dependency: the core mounts its PDF viewer on the converted bytes when a
     *  presentation has no renderable slides. */
    public static async convertPresentationToPdf(filePath: string): Promise<Buffer> {
